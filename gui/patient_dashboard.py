...
class PatientDashboard(ctk.CTkToplevel):
    ...
    def create_sidebar(self, parent):
        ...
        self.create_info_item(info_frame, "🩸", self.patient_data.get('blood_type', 'N/A'))
        self.create_info_item(info_frame, "🎂", f"{self.patient_data.get('age', 'N/A')} years")
    ...
    def create_info_item(self, parent, icon, value):
        ...
        item = ctk.CTkFrame(parent, fg_color=COLORS['bg_light'], corner_radius=RADIUS['sm'])
    ...
    def show_emergency_card(self):
        """Show emergency card"""
        messagebox.showinfo("Coming Soon", "Emergency Card PDF generation coming in Phase 6!")
    ...
    def download_records(self):
        ...
        messagebox.showinfo("Coming Soon", "Download Records feature coming in Phase 6!")
